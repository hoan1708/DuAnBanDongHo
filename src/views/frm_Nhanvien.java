...
import services.imp.ImpSV_Huy.ChucVuService;
import services.imp.ImpSV_Huy.UsersService;
...
//        txtTaikhoan.setEditable(true);
    ...
    public void Showtable() {
        try {
            ...
            Date date = sdf.parse((String) tblnhanvien.getValueAt(row, 3));
...
//        }
    ...
    private void initComponents() {
        ...
        panelGradiente1.setColorPrimario(new java.awt.Color(51, 204, 255));
        ...
        panelGradiente1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 80, 220, 20));
        ...
        panelGradiente1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 80, 220, 20));

        cbochucvu.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 204, 204), 2));
        panelGradiente1.add(cbochucvu, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 110, 220, 40));
        ...
        panelGradiente1.add(datengaysinh, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 110, 220, 40));
    ...
    private void tblnhanvienMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblnhanvienMouseClicked
        ...
        try {
            ...
            String gt = (String) tblnhanvien.getValueAt(index, 3);
            String tt = (String) tblnhanvien.getValueAt(index, 5);
            int trangthai = tt.equals("Làm việc") ? 1 : 0;
            int gioiitinh = gt.equals("Nam") ? 1 : 0;
//            txtho.setText(tblnhanvien.getValueAt(index, 1) + "");
            txtten.setText(tblnhanvien.getValueAt(index, 1) + "");
...
//            txtMatkhau.setText(tblnhanvien.getValueAt(index, 8) + "");
            SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
            Date date1 = sdf.parse((String) tblnhanvien.getValueAt(index, 2));
            ...
            if (tblnhanvien.getValueAt(index, 6).toString().equals("Quản lý")) {
                cbochucvu.setSelectedIndex(0);
            } else {
