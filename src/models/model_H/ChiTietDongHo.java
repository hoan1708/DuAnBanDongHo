...
public class ChiTietDongHo {
    ...
    public ChiTietDongHo( Integer idDH, Integer idGioiTinh, Integer idKieuMay, Integer idLoaiDayDeo, Integer idMauVo, Integer soLuong, Double giaNhap, Double giaBan, Integer idKhuyenMai, Integer idTrangThaiSP) {
