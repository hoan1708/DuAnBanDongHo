...
import repositorys.IRepo_DT.ITemPlatePBHRepository;
...
public class TemplatePBHRepository implements ITemPlatePBHRepository {
    ...
    public static void main(String[] args) {
        ...
        TemplateBaoHanh sp1 = new TemplateBaoHanh("tenSPduy11", 10);
        Boolean update = new TemplatePBHRepository().Add(sp1);
